...
public class ExactDoubleFilter<TENTITY extends BaseEntity> extends AbstractFromFilter<TENTITY, Double> {
    private final AbstractFilter<TENTITY> abstractFilter;
    private final String columnName;

    public ExactDoubleFilter(AbstractFilter<TENTITY> abstractFilter, String columnName, Double input) {
        super(input);
