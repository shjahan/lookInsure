...
public class ExactEnumFilter<TENTITY extends BaseEntity> extends AbstractFromFilter<TENTITY, Enum> {
    private final AbstractFilter<TENTITY> abstractFilter;
    private final String columnName;

    public ExactEnumFilter(AbstractFilter<TENTITY> abstractFilter, String columnName, CoverageType input) {
        super(input);
