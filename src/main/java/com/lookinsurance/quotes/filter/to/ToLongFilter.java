...
public class ToLongFilter<TENTITY extends BaseEntity> extends AbstractFromFilter<TENTITY, Long> {
    private final AbstractFilter<TENTITY> abstractFilter;
    private final String columnName;

    public ToLongFilter(AbstractFilter<TENTITY> abstractFilter, String columnName, Long input) {
        super(input);
